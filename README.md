...
This board includes pins for programming, a USB-C port (for programming & power), and a screw terminal to conveniently wire up a Lithium battery to (3.7v). And you can also utilize the PSRAM that I added externally onto the board. The board includes comprehensive labels for buttons and pins for ease of use. The cost and materials used to manufacture/make this board are in the BOM.csv file.
